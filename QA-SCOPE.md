...
| Intelligence | An agent used on the Intelligence and Research pages. On Intelligence, it uses financial statement data to answer prompts; on Research, it uses financial statement and board report data to answer prompts | Functional + data accuracy + consistency | [Detail](#intelligence-detail) |
